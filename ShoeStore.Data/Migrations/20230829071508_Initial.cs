...
namespace ShoeStore.Data.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "Description", "Name", "OriginalPrice", "Price", "Thumbnail" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 8, 29, 14, 15, 8, 716, DateTimeKind.Local).AddTicks(2245), "So Good", "Test", 100000m, 200000m, "" },
                    { 2, new DateTime(2023, 8, 29, 14, 15, 8, 716, DateTimeKind.Local).AddTicks(2262), "So Good 2", "Test 2", 200000m, 400000m, "" }
                });
